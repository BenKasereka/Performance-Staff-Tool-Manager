...
const RUBRIQUES = [
  {
    ...
    exemple:
      "La mise en place de ce corridor logistique répondait à des ruptures de stock répétées sur le terrain…",
    lignes: 5,
  },
  {
    champ: "synthese",
    ...
    exemple: "L'équipe a tenu les délais malgré des retards de dédouanement en début de période…",
    lignes: 5,
  },
  {
    champ: "pointsForts",
    ...
    exemple: "Réactivité face aux ruptures de stock, montée en autonomie de…",
    lignes: 4,
  },
  {
    champ: "defis",
    ...
    exemple: "Les retards de plusieurs fournisseurs ont décalé deux livraisons…",
    lignes: 4,
  },
  {
    ...
    exemple: "Maintenir le suivi hebdomadaire des stocks, sécuriser les contrats avec…",
    lignes: 4,
  },
  {
    champ: "conclusion",
